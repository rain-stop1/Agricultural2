// 中国省市地区数据（完整版 - 34个省级行政区）
export const regions = [
  // 直辖市（使用市辖区作为第二级）
  {
    province: '北京市',
    cities: ['市辖区', '东城区', '西城区', '朝阳区', '丰台区', '石景山区', '海淀区', '门头沟区', '房山区', '通州区', '顺义区', '昌平区', '大兴区', '怀柔区', '平谷区', '密云区', '延庆区']
  },
  {
    province: '天津市',
    cities: ['市辖区', '和平区', '河东区', '河西区', '南开区', '河北区', '红桥区', '东丽区', '西青区', '津南区', '北辰区', '武清区', '宝坻区', '滨海新区', '宁河区', '静海区', '蓟州区']
  },
  {
    province: '上海市',
    cities: ['市辖区', '黄浦区', '徐汇区', '长宁区', '静安区', '普陀区', '虹口区', '杨浦区', '闵行区', '宝山区', '嘉定区', '浦东新区', '金山区', '松江区', '青浦区', '奉贤区', '崇明区']
  },
  {
    province: '重庆市',
    cities: ['市辖区', '万州区', '涪陵区', '渝中区', '大渡口区', '江北区', '沙坪坝区', '九龙坡区', '南岸区', '北碚区', '綦江区', '大足区', '渝北区', '巴南区', '黔江区', '长寿区', '江津区', '合川区', '永川区', '南川区', '璧山区', '铜梁区', '潼南区', '荣昌区', '开州区', '梁平区', '武隆区']
  },
  // 华东地区
  {
    province: '浙江省',
...
// 格式化地区显示（省 + 市）
export const formatRegion = (province, city) => {
  if (!province) return ''
